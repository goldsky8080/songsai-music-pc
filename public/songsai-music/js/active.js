(function ($) {
    ...
    browserWindow.on('load', hidePreloader);
    ...
    if ($.fn.imagesLoaded) {
        $('.songsaiMusic-albums').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.songsaiMusic-albums').isotope({
